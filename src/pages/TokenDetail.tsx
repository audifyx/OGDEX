      ...
      <div className="card overflow-hidden mb-4">
        ...
        <div className="p-5 relative">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-4 text-xs">
            <a href={`/api/report?mint=${mint}`} target="_blank" rel="noreferrer" className="btn bg-accent text-black font-semibold inline-flex items-center gap-1.5"><FileDown className="w-3.5 h-3.5" /> Download Report</a>
